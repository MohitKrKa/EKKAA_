...
const Page1 = () => {
  ...
  return (
    <div className="relative flex   justify-center bg-black">
      ...
      {/* Description */}
      <p className="font-Poppins scale-z-200 absolute top-[30vh] left-1/2 transform -translate-x-1/2 text-white text-[1rem] font-[SF Pro Display]leading-6 font-semibold text-center max-w-[50vw] break-words">
        {data.description}
      </p>
