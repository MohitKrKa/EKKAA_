  ...
  return (
    <div className="relative flex justify-center bg-black">
      ...
      <img
        src={data.ell}
        alt=""
        className="absolute z-2 top-[24vh] left-1/2 transform -translate-x-1/2 h-[90vh] w-[80vw] max-w-[1000px]"
      />
      <img
        src={tvbg}
        alt=""
      ...
      <img
        src={data.img2}
        alt=""
        className="absolute z-2 top-[70vh] -mt-5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[55vh] w-[56vw] max-w-[1065px]"
      />
      <img
        src={data.g}
        alt=""
